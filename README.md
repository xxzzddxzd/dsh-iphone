...
其中 DSH 版本表示本仓库已完成构建、兼容检查和实机验收的适配版本；仅在完整更新 SOP 通过后才会变更。

| 组件 | 版本 | 验证环境 |
| --- | --- | --- |
| iPhone | iPhone 13 Pro Max (`iPhone14,3`) | iOS 16.1.1、rootless 越狱 |
| Node.js | 22.23.2 | iPhoneOS arm64，最低 iOS 15.0 |
| DSH | 0.1.1-rc.2 | 上游提交 `b150a551b8d465e31e418e1b2eaf5e79bbb7d28e` |
| node-pty | 1.2.0-beta.15 | iOS `posix_spawn` 后端 |
| Xray（可选） | 26.3.27 | 仅回环 HTTP 入站、VLESS 出站 |
| Web GUI | compatibility 9 | Safari/Chrome 的 iOS 16 WebKit、通知 session 深链接、移动端悬浮侧栏与主屏幕图标 |
