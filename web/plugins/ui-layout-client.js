window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-rc2-web.8QnhPR/packages/client/ui-layout/src/client/AppFrame.module.css.mjs
		const css = ".xlC_GG_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.xlC_GG_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.xlC_GG_frame{transition:none}}.xlC_GG_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:1px solid var(--dsw-alias-border-l1);grid-column:1;min-width:0;overflow:hidden}.xlC_GG_sidebarBackdrop{display:none}.xlC_GG_centerCol{flex-direction:column;grid-column:2;min-width:0;display:flex;overflow:hidden}.xlC_GG_detailsCol{border-left:1px solid var(--dsw-alias-border-l2);grid-column:3;min-width:0;overflow:hidden}.xlC_GG_frame[data-details-collapsed] .xlC_GG_detailsCol{border-left:none}.xlC_GG_handle{cursor:col-resize;z-index:2;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.xlC_GG_frame[data-dragging] .xlC_GG_handle{transition:none}@media (prefers-reduced-motion:reduce){.xlC_GG_handle{transition:none}}.xlC_GG_handle[data-side=details]:after{content:\"\";box-sizing:border-box;background:var(--dsw-alias-button-floating-fill);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);opacity:0;width:12px;height:32px;transition:opacity var(--ds-transition-duration-slow) var(--ds-ease-in-out), background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:10px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.xlC_GG_detailsCol:hover~.xlC_GG_handle[data-side=details]:after,.xlC_GG_handle[data-side=details]:hover:after,.xlC_GG_handle[data-side=details][data-dragging=true]:after{opacity:1}.xlC_GG_handle[data-side=details]:hover:after,.xlC_GG_handle[data-side=details][data-dragging=true]:after{background:var(--dsw-alias-button-floating-hover);border-color:var(--dsw-alias-border-l3)}.xlC_GG_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.xlC_GG_overlayLayer>*{pointer-events:auto}@media (max-width:1023px){.xlC_GG_frame[data-floating-sidebar] .xlC_GG_sidebarCol{z-index:10;top:max(8px, env(safe-area-inset-top));bottom:max(8px, env(safe-area-inset-bottom));left:max(8px, env(safe-area-inset-left));border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-specific-sidebar-fill);min-width:0;max-width:calc(100% - 24px);box-shadow:var(--dsw-shadow-lv3);transition:width var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:20px;position:absolute}.xlC_GG_frame[data-floating-sidebar][data-sidebar-collapsed] .xlC_GG_sidebarCol{box-shadow:none;pointer-events:none;background:0 0;border:none;border-radius:0;overflow:visible}.xlC_GG_frame[data-floating-sidebar] .xlC_GG_sidebarBackdrop{z-index:9;background:var(--dsw-alias-bg-mask-1);-webkit-backdrop-filter:var(--dsw-mask-blur);backdrop-filter:var(--dsw-mask-blur);display:block;position:absolute;inset:0}.xlC_GG_frame[data-floating-sidebar] .xlC_GG_handle[data-side=sidebar]{display:none}}@media (max-width:1023px) and (prefers-reduced-motion:reduce){.xlC_GG_frame[data-floating-sidebar] .xlC_GG_sidebarCol{transition:none}}";
		...
		var AppFrame_module_css_default = {
			"centerCol": "xlC_GG_centerCol",
			"detailsCol": "xlC_GG_detailsCol",
			"frame": "xlC_GG_frame",
			"handle": "xlC_GG_handle",
			"overlayLayer": "xlC_GG_overlayLayer",
			"sidebarBackdrop": "xlC_GG_sidebarBackdrop",
			"sidebarCol": "xlC_GG_sidebarCol"
		};
		//#endregion
		...
		*/
		...
		function AppFrame({ useStore, useSessions, actions, renderSlot }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				"data-floating-sidebar": narrow || void 0,
				"data-sidebar-collapsed": sidebarCollapsed || void 0,
				"data-details-collapsed": cols.details === 0 || void 0,
				"data-dragging": dragging || void 0,
				children: [
					!sidebarCollapsed && narrow && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: AppFrame_module_css_default.sidebarBackdrop,
						role: "presentation",
						onClick: () => {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						style: narrow ? { width: cols.sidebar } : void 0,
					...
					!narrow && !sidebarCollapsed && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DragHandle, {
						side: "sidebar",
						left: cols.sidebar,
