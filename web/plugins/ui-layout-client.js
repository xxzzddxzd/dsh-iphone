window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ".Q-1xWa_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.Q-1xWa_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.Q-1xWa_frame{transition:none}}.Q-1xWa_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:1px solid var(--dsw-alias-border-l1);grid-column:1;min-width:0;overflow:hidden}.Q-1xWa_sidebarBackdrop{display:none}.Q-1xWa_centerCol{flex-direction:column;grid-column:2;min-width:0;display:flex;overflow:hidden}.Q-1xWa_detailsCol{border-left:1px solid var(--dsw-alias-border-l2);grid-column:3;min-width:0;overflow:hidden}.Q-1xWa_frame[data-details-collapsed] .Q-1xWa_detailsCol{border-left:none}.Q-1xWa_handle{cursor:col-resize;z-index:2;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.Q-1xWa_frame[data-dragging] .Q-1xWa_handle{transition:none}@media (prefers-reduced-motion:reduce){.Q-1xWa_handle{transition:none}}.Q-1xWa_handle[data-side=details]:after{content:\"\";box-sizing:border-box;background:var(--dsw-alias-button-floating-fill);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);opacity:0;width:12px;height:32px;transition:opacity var(--ds-transition-duration-slow) var(--ds-ease-in-out), background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:10px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.Q-1xWa_detailsCol:hover~.Q-1xWa_handle[data-side=details]:after,.Q-1xWa_handle[data-side=details]:hover:after,.Q-1xWa_handle[data-side=details][data-dragging=true]:after{opacity:1}.Q-1xWa_handle[data-side=details]:hover:after,.Q-1xWa_handle[data-side=details][data-dragging=true]:after{background:var(--dsw-alias-button-floating-hover);border-color:var(--dsw-alias-border-l3)}.Q-1xWa_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.Q-1xWa_overlayLayer>*{pointer-events:auto}@media (max-width:1023px){.Q-1xWa_frame[data-floating-sidebar] .Q-1xWa_sidebarCol{z-index:10;top:max(8px, env(safe-area-inset-top));bottom:max(8px, env(safe-area-inset-bottom));left:max(8px, env(safe-area-inset-left));border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-specific-sidebar-fill);min-width:0;max-width:calc(100% - 24px);box-shadow:var(--dsw-shadow-lv3);transition:width var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:20px;position:absolute}.Q-1xWa_frame[data-floating-sidebar][data-sidebar-collapsed] .Q-1xWa_sidebarCol{box-shadow:none;pointer-events:none;background:0 0;border:none;border-radius:0;overflow:visible}.Q-1xWa_frame[data-floating-sidebar] .Q-1xWa_sidebarBackdrop{z-index:9;background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);display:block;position:absolute;inset:0}.Q-1xWa_frame[data-floating-sidebar] .Q-1xWa_handle[data-side=sidebar]{display:none}}@media (max-width:1023px) and (prefers-reduced-motion:reduce){.Q-1xWa_frame[data-floating-sidebar] .Q-1xWa_sidebarCol{transition:none}}";
		...
		var AppFrame_module_css_default = {
			"frame": "Q-1xWa_frame",
			"detailsCol": "Q-1xWa_detailsCol",
			"overlayLayer": "Q-1xWa_overlayLayer",
			"centerCol": "Q-1xWa_centerCol",
			"handle": "Q-1xWa_handle",
			"sidebarBackdrop": "Q-1xWa_sidebarBackdrop",
			"sidebarCol": "Q-1xWa_sidebarCol"
		};
		//#endregion
